    ...
    a.fn.fluid_dg = function (b, c) {
        ...
        function K() {
            function d() {
                ...
                a(".fluid_dgrelative", k).css({ width: t, height: u });
        ...
        function jb(c) {
            ...
            if (!a(".imgLoaded", m).length) {
                ...
                if (a(".fluid_dg_loader", f).is(":visible")) {
                    ...
                    a(".fluid_dg_loader", f).css({ visibility: "hidden" });
                    a(".fluid_dg_loader", f).fadeOut(400, function () {
                        a(".fluid_dg_loader", f).css({ visibility: "visible" });
                    });
                }
                var C = b.rows,
                    D = b.cols,
                ...
                while (_ < ab) {
                    ...
                    a("> .fluid_dgSlide", qb).css({ height: u, "margin-left": "-" + lb + "px", "margin-top": "-" + mb + "px", width: t });
                    lb = lb + qb.width() - 1;
                    if (_ % D == D - 1) {
                        mb = mb + qb.height() - 1;
                    }
                ...
                a.each(nb, function (c, e) {
                                ...
                                if (h != "pie") {
                                    ...
                                    if (bb <= 1.002 && !j.hasClass("stopped") && !j.hasClass("paused") && !j.hasClass("hovered")) {
                                        ...
                                        if (!j.hasClass("stopped") && !j.hasClass("paused") && !j.hasClass("hovered")) {
                                            clearInterval(L);
                                            W();
                                            a("#" + i + ", .fluid_dg_canvas_wrap", V).animate({ opacity: 0 }, 200, function () {
                                                clearTimeout(M);
                                                M = setTimeout(ib, n);
                                                jb();
                                                b.onStartLoading.call(this);
                    ...
                    if (a(s).length) {
                        ...
                        a("li", s).not(".fluid_dgcurrent").find("img").animate({ opacity: 0.5 }, 0);
                        a("li.fluid_dgcurrent img", s).animate({ opacity: 1 }, 0);
                        a("li", s).hover(
                            function () {
        ...
        if (j.length != 0) {
            ...
            a(".fluid_dg_stop", V).on("click", function () {
                O = false;
                j.addClass("paused");
                if (a(".fluid_dg_stop", V).length) {
                    a(".fluid_dg_stop", V).hide();
            ...
            a(".fluid_dg_play", V).on("click", function () {
                O = true;
                j.removeClass("paused");
                if (a(".fluid_dg_play", V).length) {
                    a(".fluid_dg_play", V).hide();
            ...
            a(".fluid_dgContent, .imgFake", g).hover(
                function () {
                    Q = true;
                },
                function () {
        ...
        if (a(r).length) {
            ...
            a(".fluid_dg_pag_ul li", f).hover(
                ...
                function () {
                    ...
                    a(".fluid_dg_thumb", this).animate({ "margin-top": "-20px", opacity: 0 }, 200, function () {
                ...
                a.each(A, function (b, c) {
                    if (a("> div", j).eq(b).attr("data-thumb") != "") {
                        var d = a("> div", j).eq(b).attr("data-thumb"),
                            e = new Image();
                        e.src = d;
                        a("li.pag_nav_" + b, r).append(a(e).attr("class", "fluid_dg_thumb").css({ position: "absolute" }).animate({ opacity: 0 }, 0));
        ...
        if (a(o).length) {
            a(o).click(function () {
                if (!j.hasClass("fluid_dgsliding")) {
                    ...
                    clearInterval(L);
                    W();
                    a("#" + i + ", .fluid_dg_canvas_wrap", f).animate({ opacity: 0 }, 0);
                    ib();
                    if (c != 0) {
                        jb(c);
                    } else {
        ...
        if (a(p).length) {
            a(p).click(function () {
                if (!j.hasClass("fluid_dgsliding")) {
                    ...
                    clearInterval(L);
                    W();
                    a("#" + i + ", .fluid_dg_canvas_wrap", V).animate({ opacity: 0 }, 0);
                    ib();
                    if (c == B - 1) {
                        jb(1);
                    } else {
        ...
        if (a(s).length) {
            ...
            a(".fluid_dg_thumbs_cont .fluid_dg_prevThumbs", V).hover(
                function () {
            ...
            a(".fluid_dg_thumbs_cont .fluid_dg_nextThumbs", V).hover(
                function () {
                    a(this).stop(true, false).animate({ opacity: 1 }, 250);
                },
                function () {
